  ...
  setTimeout(() => {
    fetch("/play", {
      ...
      .then((data) => {
        ...
        document.getElementById("cpu-choice").textContent = data.computer_choice;
...
function resetGame() {
  fetch("/reset", { method: "POST" })
    ...
    .then(() => {
      ...
      document.getElementById("thinking").style.display = "none";
      document.getElementById("history-list").innerHTML = '<span class="history-empty">No rounds yet...</span>';
